...
from api.views import (
    index_frontend_view,
    jobs_frontend_view,
    jobseeker_auth_frontend_view,
    jobseeker_signup_frontend_view,
    employer_signup_frontend_view,
    employer_job_listings_frontend_view,
    employer_auth_frontend_view,
    upload_cv_frontend_view,
    employer_dashboard_frontend_view,
    contact_us_frontend_view,
    jobseeker_dashboard_frontend_view,
    jobseeker_profile_second_frontend_view,
    employer_profile_frontend_view,
    jobseeker_browse_jobs_frontend_view,
    jobseeker_profile_frontend_view,
    my_jobs_frontend_view,
    employer_new_job_frontend_view,
    sign_up,
    login,
    get_all_users,
    get_user_by_user_id,
    ...
    get_jobseeker_dashboard_metrics,
    file_upload,
    save_job,
    return_saved_jobs,
    get_saved_jobs_by_user,
    get_all_jobs_by_employer,
    remove_saved_job,
)
